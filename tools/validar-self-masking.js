...
const PATTERNS = [
  {
    ...
    desc: 'test/skip em código',
    exts: ['.js', '.ts', '.tsx', '.jsx'],
  },
  { re: /\bxit\s*\(/, desc: 'xit em código', exts: ['.js', '.ts', '.tsx', '.jsx'] },
  { re: /\bxdescribe\s*\(/, desc: 'xdescribe em código', exts: ['.js', '.ts', '.tsx', '.jsx'] },
  {
    re: /assert(?:\.equal)?\s*\(\s*true\s*,\s*true\s*\)/,
    desc: 'assert(true, true)',
    exts: ['.js', '.ts'],
  },
  {
    re: /assertTrue\s*\(\s*true\s*\)/,
    desc: 'assertTrue(true) - assertiva vazia',
    exts: ['.js', '.ts'],
  },
  ...
  // em scripts utilitários.
  {
    ...
    desc: '|| true em comando de teste',
    exts: ['.yml', '.yaml', '.sh', '.json'],
  },
];
