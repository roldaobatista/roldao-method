...
| `devops-infra` | CI/CD, deploy, IaC, observabilidade, secrets, cloud BR | sonnet |
...
| `validar-chave-acesso-nfe` | Valida chave de 44 dígitos NF-e/NFC-e/CT-e/MDF-e/SAT-CF-e |
| `validar-codigo-municipio-ibge` | Valida código IBGE de município (7 dígitos + DV módulo 10) |
