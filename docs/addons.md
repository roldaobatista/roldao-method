...
| [`fintech-br`](../addons/fintech-br/) | Pix completo (chave, BR Code, cobrança, devolução, Pix Automático) + Open Finance Brasil | `pix-arch` | `validate-webhook-signature` | `gerar-br-code-typescript`, `validar-webhook-pix`, `estruturar-open-finance` |
