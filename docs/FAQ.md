...
- **Claude Code:** suporte nativo (14 agentes executáveis, 26 hooks bloqueadores [23 via `exit 2` + 3 via JSON `decision:block`], 22 commands, 12 skills com algoritmo Python).
