...
- **Claude Code:** suporte nativo (15 agentes executáveis, 37 hooks [26 bloqueadores + 2 soft warnings + 8 lifecycle + 1 utilitário], 28 commands, 9 skills com algoritmo Python + 4 skills prompt-only = 13 skills core).
