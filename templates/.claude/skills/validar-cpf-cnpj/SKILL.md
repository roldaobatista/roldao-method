...
description: Valida CPF e CNPJ (numerico legado + alfanumerico apos jul/2026) brasileiros usando algoritmo de digitos verificadores. Use sempre que precisar verificar se um CPF/CNPJ está MATEMATICAMENTE valido antes de salvar ou processar.
