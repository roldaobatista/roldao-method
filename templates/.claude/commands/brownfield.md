---
description: Onboarding de projeto legado. Investigador varre o codigo/banco/docs existentes e preenche os campos vazios do AGENTS.md + cria docs/arquitetura/ARQ-001.md. Use ao adotar ROLDAO-METHOD em projeto que ja existe.
