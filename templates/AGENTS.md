...
- **Addons (`npx roldao-method add <nome>`):** pacotes de domínio (`fintech-br`, `fiscal-br-completo`, `electron-br`, `esocial-completo`, `lgpd-compliance`, `varejo-pdv-br`). Liste com `npx roldao-method search`.
